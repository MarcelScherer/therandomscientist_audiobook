...
#
# $Id: pmpcmp3.py,v 1.1 2002/04/25 19:30:53 jalet Exp $
#
# NB : This module was written and put in the public domain
#      by Scott Hassan. Many thanks to him. My single modification
#      to it was to add the above copyright placing
#      it effectively under the GNU GPL ;-)
#      Of course you can still download the original module from
#      the Net if you plan to use it in a non-GPLed software.
#
#
